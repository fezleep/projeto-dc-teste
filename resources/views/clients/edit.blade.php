    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                {{-- O método do formulário é POST, mas Laravel usa @method('PUT') para PATCH/PUT --}}
                <form method="POST" action="{{ route('clients.update', $client) }}">
                    @csrf
                    @method('PUT') {{-- Isso informa ao Laravel que é uma requisição PUT/PATCH --}}

                    <div class="mb-3">
                        <label for="name" class="form-label">Nome do Cliente</label>
                        {{-- old('name', $client->name) preenche o campo com o valor atual ou com o valor antigo se houver erro --}}
